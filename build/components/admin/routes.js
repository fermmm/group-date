...
function adminRoutes(r) {
    ...
    (0, route_tools_1.createRoute)(r, "/admin/db/force", "GET", models_1.forceXmlDatabaseBackupGet);
    ...
    (0, route_tools_1.createRoute)(r, "/admin/run-code", "POST", models_1.runCodePost);
