...
function testingRoutes(r) {
    route_tools_1.createRoute(r, "/testing/create-fake-users", "GET", models_1.createFakeUsersPost);
    route_tools_1.createRoute(r, "/testing/create-fake-tags", "GET", models_1.createFakeTagsPost);
    route_tools_1.createRoute(r, "/testing/force-groups-search", "GET", models_1.forceGroupSearch);
    route_tools_1.createRoute(r, "/testing/create-fake-chat", "GET", models_1.createFakeChatConversation);
    route_tools_1.createRoute(r, "/testing/temp", "GET", async (params, ctx) => {
        var _a;
        console.time("notify");
        // await notifyAllUsersAboutNewCards();
        const allUsers = await data_conversion_1.fromQueryToUserList(queries_1.queryToGetAllCompleteUsers(), false, false);
        for (const user of allUsers) {
            if (((_a = user.images) === null || _a === void 0 ? void 0 : _a.length) != null) {
                let query = queries_1.queryToGetUserByToken(user.token);
